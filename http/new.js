/**
 * Created by Chao on 2017/03/13.
 */
var test = document.getElementById("drop");
var str = "str";
...
function draw(){
    ctx.fillStyle="rgba(0,0,0,0.09)";"#F0FFF0";//"rgba(0,0,0,0.09)";
    ...
    for(var i=0;i<drops.length;i++){
        ...
        drops[i]++;
        if(drops[i]*fsize > canvas.height && Math.random() > 0.9){
            drops[i] = 0;
        }

        str = drops[i]+",";
    }
    test.innerText = columns + " , i:" + str;
